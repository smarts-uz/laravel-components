<!--Body-->
<form name="eri_form" action="{{$url}}" id="eri_form" method="post" class="mt-4">
    @csrf
    <div>
        <select data-maximum-selection-length="3" data-placeholder="Выберите ключ" id='social' class="form-control select2 select2-container-multi" name="key" onchange="cbChanged(this)"></select>
    </div>
    <script !src="">
